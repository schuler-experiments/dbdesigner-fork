...
uses
  {$IFDEF MSWINDOWS}Windows, {$ENDIF}SysUtils, Types, Classes, Graphics, Controls, Forms, Dialogs,
  StdCtrls, EERModel, MaskEdit, ExtCtrls, Qt, LCLType, StrUtils, EditorTable;
